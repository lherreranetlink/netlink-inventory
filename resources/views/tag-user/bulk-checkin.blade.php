                        ...
                        <table >
                            <tr ng-repeat="i in getNumber(data.number_checkins) track by $index">
                                <td ng-show="selectedModel.is_mac=='yes'">
                                    ...
                                    <input type="text" ng-model="data.mac[$index]" name="model_number" class="form-control" required="" />
                                </td>
                                <td ng-show="selectedModel.identifier=='yes'">
                                    <label>@{{selectedModel.identifier_name}}</label>
                                    <input type="text" ng-model="data.identifier[$index]" name="model_number" class="form-control" required="" />
                                </td>
                            </tr>
