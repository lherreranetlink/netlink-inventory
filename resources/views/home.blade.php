...
<script type="text/javascript" src="{{url('angular/reports_app.js')}}"></script>
            ...
            <div class="panel-body">
                <div class="col-lg-12 col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-barcode"></i> Scan Barcode/Search Manually </a> 
                                | <a style="border-bottom: 1px dashed #FF0000;" href="{{url('/bulk-checkin')}}" ><i class="fa fa-arrow-down" ></i> Bulk Check-In</a>
                                | <a style="border-bottom: 1px dashed #FF0000;" href="{{url('/bulk-checkout')}}" ><i class="fa fa-arrow-up" ></i> Bulk Check-Out</a>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <label style="color: #0080C0; font-weight: bold;"><i class="fa fa-search"></i> Search by Barcode (MAC or ID or SN):</label><small style="color: gray; font-style: italic; font-weight: bold;">Search any MAC/SN/Barcode to 'check status' of the product or to 'check-in' new product.</small>
                            <input autofocus="true" id="inputError2" class="form-control barcode-input" ng-model="barcode" ng-keyup="$event.keyCode == 13 && getProductDetail()" placeholder="Please Scan Barcode and Press Enter..." /><br />
                ...
                <!-- Summary/Report ---------------------------------------------->
                <div class="col-lg-12" ng-controller="reportCTRL">
                    <script>
                        var manufacturer_report_url = "{{url('/items-by-manufacturer-json')}}";
                        var category_report_url = "{{url('/items-by-category-json')}}";
                    </script>
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-list-alt"></i> Summary/Report </a>
                            </h3>
                        </div>
                        <div class="panel-body">
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">   
                                            <label ng-if="manufacturerLoadWait" style="color: red;">Please Wait...</label>
                                            <div ng-repeat="manu in manufacturers">
                                                <a href="" data-toggle="modal" data-target="#reportItemDetailModalMFG"  ng-click="manufacturerClick(manu)">@{{manu.manufacturer}} <label>@{{manu.count}}</label></a>
                                            </div>  
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="panel">
                                        ...
                                        <div class="panel-body"> 
                                            <label ng-if="categoryLoadWait" style="color: red;">Please Wait...</label>
                                            <div ng-repeat="cat in categories">
                                                <a href="" data-toggle="modal" data-target="#reportItemDetailModalCAT"  ng-click="categoryClick(cat)">@{{cat.category}} <label>--</label></a>
                                            </div>  
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Report Modal -->
                    <div id="reportItemDetailModalMFG" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                              <button type="button" class="btn btn-danger" data-dismiss="modal" ng-click="closeReportModal()" >Close <i class="fa fa-close"></i></button>
                          </div>
                        </div>
                    ...
                    <!-- Report Modal -->
                    <div id="reportItemDetailModalCAT" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Available @{{items.category}} (s)</h4>
                          </div>
                          <div class="modal-body">
                              <label>Total Available: @{{items.count}}</label>
                              <div ng-repeat="item in items.items[0]">
                                  <label>@{{item.model_id}} | @{{item.mac}} | @{{item.identifier}}</label>
                              </div>
                          </div>
                          <div class="modal-footer">
                              <button type="button" class="btn btn-danger" data-dismiss="modal" ng-click="closeReportModal()" >Close <i class="fa fa-close"></i></button>
