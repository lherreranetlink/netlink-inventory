...
@section('title')
<u style="font-weight: bold;">Categories</u>
@endsection
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-fw fa-table"></i> Categories | <a style="border-bottom: 1px dashed #FF0000;" href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle" ></i> Add New</a>
                </h3>
            </div>
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <!--
                    <a href="{{url('/subcategories')}}" class="btn btn-primary">SubCategories</a>
                    <a href="{{url('/childcategories')}}" class="btn btn-primary">ChildCategory</a>
                    -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="get" action="{{url('/categories/edit')}}">
                                        {{ csrf_field() }}
                                    ...
                                    <!-- Modal -->
                                    <div id="deleteCategoryConfirm_<?php echo $category['id']; ?>" class="modal fade" role="dialog">
                                      <div class="modal-dialog">
                                        <!-- Modal content-->
                                        <div class="modal-content">
                                        <form class="form-horizontal" method="post" action="{{url('/delete-category')}}">
                                          {{ csrf_field() }}
                                ...
                                <td>
                                    <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteCategoryConfirm_<?php echo $category['id']; ?>"><i class="glyphicon glyphicon-trash"></i>
                                    </button>
                                </td>
                                <td>
                                    <a href="{{url('categories/subcategories')}}/{{$category['id']}}" class="btn btn-success btn-sm">
                                        <i class="fa fa-list"></i> Subcategories (<b>{{count($category->subcategories)}}</b>)
                                    </a>
                                </td>
                            </tr>
                            <?php
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
        <form style="padding: 20px;" class="form-horizontal" method="post" action="{{url('/categories')}}">
          {{ csrf_field() }}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
