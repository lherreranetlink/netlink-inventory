...
@section('title')
<u style="font-weight: bold;">Locations</u><i class="fa fa-arrow-right"></i><u style="font-weight: bold;">{{$data['sublocation']->location->name}}
    <i class="fa fa-arrow-right"></i><span style="color: darkred;">{{$data['sublocation']['name']}}</span></u>
@endsection
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-fw fa-table"></i> Child Locations | <a style="border-bottom: 1px dashed #FF0000;" href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle" ></i> Add New</a>
                </h3>
            </div>
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <a href="{{url('/locations/sublocations')}}/{{$data['sublocation']->location->id}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Sub Locations</a>
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $childlocation['description']; ?></td>
                                          ...
                                          <div class="modal-body">
                                              <div class="row" >
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="hidden" name="sublocation_id" value="<?php echo $childlocation->sublocation->id; ?>"/>
                                                </div>
                                              </div>
                                          </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
        <form style="padding: 20px;" class="form-horizontal" method="post" action="{{url('/childlocation-by-sub')}}">
          {{ csrf_field() }}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">New Child Location for "{{$data['sublocation']['name']}}"</h4>
      </div>
      <div class="modal-body">
          <div class="row" >
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <input name="sublocation_id" type="hidden" value="{{$data['sublocation_id']}}" />
                </div>
            </div>
          </div>
      </div>
