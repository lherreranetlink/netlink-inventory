...
@section('title')
<u style="font-weight: bold;">Categories</u><i class="fa fa-arrow-right"></i><u style="font-weight: bold;">{{$data['subcategory']->category->name}}<i class="fa fa-arrow-right"></i><span style="color: darkred;">{{$data['subcategory']['name']}}</span></u>
@endsection
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-fw fa-table"></i> Child Categories | <a style="border-bottom: 1px dashed #FF0000;" href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle" ></i> Add New</a>
                </h3>
            </div>
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <a href="{{url('categories/subcategories/')}}/{{$data['subcategory']->category->id}}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Sub Categories</a>
                                          ...
                                          <div class="modal-body">
                                              <div class="row" >
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="hidden" name="sub_category_id" value="<?php echo $childcategory->subcategory->id; ?>"/>
                                                </div>
                                              </div>
                                          </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
        <form style="padding: 20px;" class="form-horizontal" method="post" action="{{url('childcategory-by-sub')}}">
          {{ csrf_field() }}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Add Child Category for <b>{{$data['subcategory']['name']}}</b></h4>
      </div>
      <div class="modal-body">
          <div class="row" >
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" value="{{$data['subcategory_id']}}" name="sub_category_id" />
                </div>
            </div>
          </div>
      </div>
