...
@section('title')
<u style="font-weight: bold;">Categories</u><i class="fa fa-arrow-right"></i><u style="font-weight: bold;">{{$data['category']['name']}}</u>
@endsection
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                          ...
                                          <div class="modal-body">
                                              <div class="row" >
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="hidden" name="category_id" value="<?php echo $subcategory->category->id; ?>"/>
                                                </div>
                                              </div>
                                          </div>
                                ...
                                <td>
                                    <a href="{{url('categories/subcategories/childcategories')}}/{{$subcategory['id']}}" class="btn btn-success btn-sm">
                                        <i class="fa fa-list"></i> Child Categories
                                        (<b>{{count($subcategory->childcategories)}}</b>)
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
        <form style="padding: 20px;" class="form-horizontal" method="post" action="{{url('categories/subcategories')}}">
          {{ csrf_field() }}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
