...
@section('title')
{{$data['title']}}: <u style="font-weight: bold;">Sub Location</u>
@endsection
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-fw fa-table"></i> Sub Locations <small>(Sub Division of Locations)</small> | <a style="border-bottom: 1px dashed #FF0000;" href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle" ></i> Add New</a>
                </h3>
            </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <div class="modal-content">
        <form style="padding: 20px;" class="form-horizontal" method="post" action="{{url('/sublocations')}}">
          {{ csrf_field() }}
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Add New Sublocation</h4>
      </div>
      <div class="modal-body">
          <div class="row" >
            <div class="col-md-12">
