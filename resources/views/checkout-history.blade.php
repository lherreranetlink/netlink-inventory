            ...
            <div class="panel-body">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php if(isset($checkout->model)){ ?>
                            {{$checkout->model->manufacturer->name}} {{$checkout->model->model_number}} | {{$checkout->model->category->name}}
                            <?php }
                            else{
                                echo "Error:404";
                            }
                        ...
                        <td><?php 
                        if(isset($checkout->inout->customer)){
                            echo $checkout->inout->customer->name;
                        }
                        else{
                            echo "--";
                        }
                        ?></td>
                        <td><?php if(isset($checkout->inout->mac)){echo $checkout->inout->mac;} ?> | <?php if(isset($checkout->inout->identifier)){echo $checkout->inout->identifier;} ?></td>
